$(function(){
    $(".container .main").before(domJSON.ie8+domJSON.header).after(domJSON.footer);
    // 判断浏览器宽度改变主体样式适应
    (function(){
        resizeW();
...
var domJSON = {
    ie8:"<!--[if IE 8]>\
    <style>\
        html body .container .header{background: none;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://127.0.0.1:8020/web36/images/header_bg.png', sizingMethod='scale');}\
        html body .container .main{background: none;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://127.0.0.1:8020/web36/images/main_bg.png', sizingMethod='scale');}\
        html body .container .footer{background: none;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='http://127.0.0.1:8020/web36/images/footer_bg.png', sizingMethod='scale');}\
    </style>\
<![endif]-->",
